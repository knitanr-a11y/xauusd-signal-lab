...
3. `docs/gold_ml_v1/GML1_MLR1_STAGE_ML00_DESIGN_CONTRACT_20260627.md`
4. existing GOLD_ML_V1 start/handoff documents only as needed for immutable boundaries

Current state:

- ML-00 design contract complete
- next stage: ML-01 raw-data and timestamp audit
