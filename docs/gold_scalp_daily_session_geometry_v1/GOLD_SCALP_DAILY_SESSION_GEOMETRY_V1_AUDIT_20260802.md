...
- Canonical M1 union: 1,167,591 rows, 2023-01-03 01:00:00 to 2026-07-31 23:56:00.
- Canonical M5 union: 253,557 rows, 2023-01-03 01:00:00 to 2026-07-31 23:50:00.
- `gold_v3` M1 had 1 appended-chunk reversal, 0 conflicting duplicate timestamps, and 2 invalid bridge rows.
- Later appended M1 chunk was preferred deterministically; `goldsharp` overlap (114,032 rows) matched exactly.
- 2024H1 and 2024H2 fail the >=99% exact-M1 block coverage gate and are excluded from formal exact-M1 pseudo-forward.
...
- CATALOG — RAW_SELECTED_EXACT_M1: n=33, WR=45.45% PF=0.7812 Net=-15.75 DD=32.25
- CATALOG — GLOBAL_DEDUP_EXACT_M1: n=33, WR=45.45% PF=0.7812 Net=-15.75 DD=32.25
...
- BALANCED — RAW_SELECTED_EXACT_M1: n=33, WR=45.45% PF=0.7812 Net=-15.75 DD=32.25
- BALANCED — GLOBAL_DEDUP_EXACT_M1: n=33, WR=45.45% PF=0.7812 Net=-15.75 DD=32.25
