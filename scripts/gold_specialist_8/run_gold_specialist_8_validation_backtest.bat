...
echo ============================================================
echo GOLD specialist 8 validation backtest/outcome builder
echo - MT5 order_send DISABLED
echo - Discord send DISABLED
echo - builds validation trade outcome ledger for AI review
echo - generated files: data\gold_specialist_8\verification\backtests\YYYY\MM\YYYYMMDD_HHMMSS
...
python scripts\gold_specialist_8\run_gold_specialist_8_validation_backtest.py ^
...
echo.
echo validation backtest exit_code=%EXIT_CODE%
pause
exit /b %EXIT_CODE%
