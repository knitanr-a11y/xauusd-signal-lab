...
set "OUT_DIR=%MT5_FILES_DIR%\FX_OUTPUTS\gold_v3\107ghc"
if not exist "%OUT_DIR%" mkdir "%OUT_DIR%"
echo GOLD V3 Stage107GH audit-only
...
echo.
py -3 "%REPO_ROOT%\scripts\gold_v3_runtime\gold_v3_107gh_fixed_portfolio_sticky_gate_audit.py" --mt5-files-dir "%MT5_FILES_DIR%"
if errorlevel 1 (
  echo py failed. Trying python...
  python "%REPO_ROOT%\scripts\gold_v3_runtime\gold_v3_107gh_fixed_portfolio_sticky_gate_audit.py" --mt5-files-dir "%MT5_FILES_DIR%"
)
echo.
