...
python "%R%\scripts\gold_v3_runtime\gold_v3_93_signal_gated_ledger_sidecar_release_precheck_audit.py" --candle-dir "%F%"
set "E=%ERRORLEVEL%"
echo.
echo Paste: %F%\FX_OUTPUTS\gold_v3\93c\paste_me.txt
pause
exit /b %E%
