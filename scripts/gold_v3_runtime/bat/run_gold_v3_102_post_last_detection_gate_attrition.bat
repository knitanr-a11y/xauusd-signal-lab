...
python "%R%\scripts\gold_v3_runtime\gold_v3_102_post_last_detection_gate_attrition_audit.py" --candle-dir "%F%"
set "E=%ERRORLEVEL%"
echo.
echo Paste: %F%\FX_OUTPUTS\gold_v3\102c\paste_me.txt
pause
exit /b %E%
