...
set "OUT_DIR=%MT5_FILES_DIR%\FX_OUTPUTS\gold_v3\107gpc"
if not exist "%OUT_DIR%" mkdir "%OUT_DIR%"
echo GOLD V3 Stage107GP audit-only
...
echo.
py -3 "%REPO_ROOT%\scripts\gold_v3_runtime\gold_v3_107gp_daily_density_target_portfolio_audit.py" --mt5-files-dir "%MT5_FILES_DIR%"
if errorlevel 1 (
  echo py failed. Trying python...
  python "%REPO_ROOT%\scripts\gold_v3_runtime\gold_v3_107gp_daily_density_target_portfolio_audit.py" --mt5-files-dir "%MT5_FILES_DIR%"
)
echo.
