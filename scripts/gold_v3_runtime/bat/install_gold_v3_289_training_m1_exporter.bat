...
cd /d "%~dp0\..\..\.."
set "SOURCE=%CD%\scripts\gold_v3_runtime\mt5\ExportGoldStage289TrainingHistory_v110.mq5"
set "FILES_DIR="
...
copy /Y "%SOURCE%" "%MQL5_DIR%\Scripts\ExportGoldStage289TrainingHistory_v110.mq5" >nul
if errorlevel 1 (
...
echo %MQL5_DIR%\Scripts\ExportGoldStage289TrainingHistory_v110.mq5
echo.
echo This exporter writes historical GOLD M1, M5 and M15 files.
echo Next steps in MT5:
echo 1. Open MetaEditor and compile ExportGoldStage289TrainingHistory_v110.mq5 with F7.
echo 2. In MT5 Navigator, refresh Scripts.
echo 3. Run ExportGoldStage289TrainingHistory_v110 once on a GOLD chart.
