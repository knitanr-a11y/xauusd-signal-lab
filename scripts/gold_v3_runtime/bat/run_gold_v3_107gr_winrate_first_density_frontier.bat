...
echo GOLD V3 Stage107GR audit-only FAST V2
echo Runtime estimate: fast progress version, seconds to minutes. Stop and report if over 1 hour.
echo Purpose: reduce trade count to improve OOS win rate; density frontier 0.5 / 1.0 / 1.5 / 2.0 trades per business day.
echo Progress should be visible below: START, input rows, each split, every 50 configs, DONE.
