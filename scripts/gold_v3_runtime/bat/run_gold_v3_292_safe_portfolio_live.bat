...
echo [1/3] Refreshing BASE condition detector...
...
echo [2/3] Refreshing BASE health decision...
%PYTHON_CMD% "%RUNTIME%\gold_v3_70_live_csv_signal_decision_preview_audit.py" --candle-dir "%FILES_DIR%"
if errorlevel 1 (echo [BLOCKED] Stage70 failed.& pause& exit /b 6)
echo [3/3] Running safe portfolio live controller...
