...
python "%R%\scripts\gold_v3_runtime\gold_v3_94_signal_gated_stage80_sidecar_patch_plan_audit.py" --candle-dir "%F%"
set "E=%ERRORLEVEL%"
echo.
echo Paste: %F%\FX_OUTPUTS\gold_v3\94c\paste_me.txt
pause
exit /b %E%
