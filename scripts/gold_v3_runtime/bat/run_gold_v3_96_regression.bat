...
python "%R%\scripts\gold_v3_runtime\gold_v3_96_stage80_default_no_signal_gated_regression_audit.py" --candle-dir "%F%"
set "E=%ERRORLEVEL%"
echo.
echo Paste: %F%\FX_OUTPUTS\gold_v3\96c\paste_me.txt
pause
exit /b %E%
