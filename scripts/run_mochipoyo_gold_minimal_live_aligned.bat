...
REM GOLD minimal live notification launcher, aligned to HH:MM:02
REM - Runs the validated Python loop with minute-second alignment
...
REM - Do NOT run this together with the demo auto-trade forever bat
...
echo Aligned start: every minute at second 02
