...
echo ============================================================
echo GOLD multi-strategy GUARDED DEMO SEND FOREVER aligned runner + AI Discord
...
echo Multi AI Discord send ledger: %STATE_DIR%\multi_ai_history_discord_send_ledger.csv
...
echo AI history warning: payload 0 cycles create marker; payload >0 cycles send Discord with AI text
echo Stop with Ctrl+C
echo ============================================================

python scripts\run_gold_multi_strategy_guarded_demo_send_forever_aligned_weekly_state_ai_discord.py ^
...
python scripts\notify_mochipoyo_loop_stopped.py ^
  --loop-name gold_multi_strategy_guarded_demo_send_forever_aligned_weekly_state_ai_discord ^
  --exit-code %EXITCODE% ^
...
echo ============================================================
echo GOLD multi-strategy guarded demo-send weekly-state AI-Discord runner exit code: %EXITCODE%
