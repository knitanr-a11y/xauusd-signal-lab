@echo off
setlocal
title GOLD P75 State Survival Shadow - Status
...
echo ============================================================
echo GOLD P75 STATE SURVIVAL SHADOW - STATUS
echo ============================================================
if not exist "%PY%" (
...
pushd "%ROOT%"
"%PY%" -m scripts.gold_scalp_state_survival_shadow.shadow_runtime status --config "%CFG%"
set "RC=%ERRORLEVEL%"
popd
