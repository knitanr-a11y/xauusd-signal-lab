...
python "scripts\mochipoyo_alert_research\common\python\run_bounded_adapter_loop_v2.py" --loop M10P --interval-seconds 60 --compat-process-marker m10p_guarded_runtime.py
set "RC=%ERRORLEVEL%"
echo.
if not "%RC%"=="0" (
