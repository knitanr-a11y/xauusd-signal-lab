...
python "scripts\mochipoyo_alert_research\common\python\run_bounded_adapter_loop_v2.py" --loop M10W19 --interval-seconds 60 --compat-process-marker m10w19_runtime.py
set "RC=%ERRORLEVEL%"
echo.
