...
REM GOLD multi-strategy guarded demo-send once ALLOW-ONLY entry.
REM Safety:
REM - This BAT passes --allow-demo-send only.
...
set OUT_DIR=data\r\gds_once_allow_only

echo ============================================================
echo GOLD multi-strategy guarded demo-send once ALLOW-ONLY
echo --allow-demo-send only / NO --send / NO production registry write
...
echo ============================================================
echo GOLD guarded demo-send once ALLOW-ONLY exit code: %EXIT_CODE%
