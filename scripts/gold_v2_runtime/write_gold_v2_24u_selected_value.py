...
VALUE = "APPROVE_SOURCE_RECOVERY_FINAL_READINESS_FOR_EXECUTION_PLANNING_AUDIT_ONLY"
OUT_DIR = "gold_v2_24u_source_recovery_readiness_final_decision_intake_audit_only"
OUT_FILE = "gold_v2_24u_human_decision_input.json"
...
def main() -> int:
    ...
    payload = {
        "created_by_helper": "write_gold_v2_24u_selected_value.py",
        "created_utc": datetime.now(timezone.utc).isoformat(),
        "audit_only": True,
        "selected_decision_value": VALUE,
        "human_operator_notes": "selected by operator; 24U validates for later routing audit only",
    }
    target = out / OUT_FILE
