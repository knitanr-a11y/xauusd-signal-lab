...
MOD_PATH = HERE / "audit_gold_v2_24ae_choice_intake_audit_only.py"
TEMPLATE_FILE = "gold_v2_24ae_human_decision_input_template.json"
OUTPUT_FILE = "gold_v2_24ae_human_decision_input.json"
CHOICE_INDEX = 3


def load_mod():
    spec = importlib.util.spec_from_file_location("m24ae", MOD_PATH)
    if spec is None or spec.loader is None:
        raise RuntimeError("cannot load 24ae module")
...
def main() -> int:
    ...
    payload = {
        "created_by_helper": "write_24ae_choice4.py",
