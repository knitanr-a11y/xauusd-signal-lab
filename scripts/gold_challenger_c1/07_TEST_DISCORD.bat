@echo off
setlocal
title GOLD Challenger C1 Shadow - Discord Test
...
echo ============================================================
echo GOLD CHALLENGER C1 SHADOW - DISCORD TEST
...
pushd "%ROOT%"
"%PY%" -m scripts.gold_challenger_c1.discord_notifier --config "%CONFIG%" test
set "RC=%ERRORLEVEL%"
popd
pause
exit /b %RC%
