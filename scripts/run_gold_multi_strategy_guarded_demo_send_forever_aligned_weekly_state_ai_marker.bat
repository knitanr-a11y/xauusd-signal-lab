...
echo ============================================================
echo GOLD multi-strategy GUARDED DEMO SEND FOREVER aligned runner + AI marker
...
echo AI history warning preview marker: payload 0 cycles create SKIPPED_NO_PAYLOAD_ROWS txt/json
echo Stop with Ctrl+C
echo ============================================================

python scripts\run_gold_multi_strategy_guarded_demo_send_forever_aligned_weekly_state_ai_marker.py ^
...
python scripts\notify_mochipoyo_loop_stopped.py ^
  --loop-name gold_multi_strategy_guarded_demo_send_forever_aligned_weekly_state_ai_marker ^
  --exit-code %EXITCODE% ^
...
echo ============================================================
echo GOLD multi-strategy guarded demo-send weekly-state AI-marker runner exit code: %EXITCODE%
