...
echo [RECOVERY_FF05_RERUN] Isolation mode V4 hides real profile paths and mirrors prerequisite LATEST only.
...
%PYTHON_CMD% "scripts\btc_ml_v1\RECOVERY_FF05_full_history_rerun\python\run_RECOVERY_FF05_full_history_rerun_v4.py" --output-root "%OUTPUT_ROOT%" %*
